-- LazyVim https://github.com/LazyVim/LazyVim/blob/ec5981dfb1222c3bf246d9bcaa713d5cfa486fbd/lua/lazyvim/plugins/extras/lang/sql.lua
...
return {
...

  {
    ...
    dependencies = 'vim-dadbod',
    keys = {
      -- LazyVim defaults to `<leader>D` for toggling
      { '<leader>tq', '<cmd>DBUIToggle<CR>', desc = 'Toggle DBUI' },
    },
    init = function()
      ...
      vim.g.db_ui_use_nerd_fonts = true -- important for nice style. Defaults to false
