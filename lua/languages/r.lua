-- All my configurations for the R programming language.
--
-- Mostly based on LazyVim's configuration for R:
-- https://github.com/LazyVim/LazyVim/blob/main/lua/lazyvim/plugins/extras/lang/r.lua

-- -- Deleted code from LazyVim:
--
...
return {
  ...
  -- Me: research `|>` vs `%>%` pipe: [url](https://www.tidyverse.org/blog/2023/04/base-vs-magrittr-pipe/)
  {
    ...
    opts = {
      ...
      --
      -- --quite: Suppresses startup messages
      -- --no-save: Suppresses saving the workspace image
