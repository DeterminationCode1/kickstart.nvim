-- -- repo: https://github.com/nvim-telescope/telescope-frecency.nvim
-- -- WARNING: as of Dec. 2024, I switched to the "smart-open.nvim" for a
-- smiliar functinality, but a bit smarter...
-- --
-- -- Add frecency (frequency + recency) sorting to telescope search results.

-- -- Basic config was copied from: Linkarzu's dotfiles
-- -- https://github.com/linkarzu/dotfiles-latest/blob/main/neovim/neobean/lua/plugins/telescope-frecency.lua
...
-- shows the ones I see the most at the top of the list
...
--     -- Keybindings are in telescope config file.
--   end,
-- }
return {}
