-- Lazyvim https://github.com/LazyVim/LazyVim/blob/ec5981dfb1222c3bf246d9bcaa713d5cfa486fbd/lua/lazyvim/plugins/extras/ui/edgy.lua
...
return {
  -- edgy
  {
    ...
    keys = {
      {
        '<leader>tu', -- defaults to <leader>ue
        function()
          require('edgy').toggle()
        end,
        desc = 'Edgy Toggle',
    ...
    opts = function()
      ...
      if LazyVim.has 'neo-tree.nvim' then
        local pos = {
          filesystem = 'right', -- defaults to 'left'
          buffers = 'top',
          git_status = 'right',
